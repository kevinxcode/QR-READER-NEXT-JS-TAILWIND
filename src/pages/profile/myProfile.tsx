          ...
          <div className="flex flex-wrap -mx-3">
            ...
            <div className="w-full max-w-full px-3 text-right shrink-0 md:w-4/12 md:flex-none">
              ...
              <div
                ...
                style={{position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(341.333px, 171px, 0px);}}
              >
                Edit Profile
                <div
